function cnmf_e_bastijn_batch(Fs,ssub,tsub,gSig,gSiz,min_corr,min_pnr,bd,saveim)
...
% gSig = 7;           % [mouse deep brain: 7, rat 10] width of the gaussian kernel, which can approximates the average neuron shape
