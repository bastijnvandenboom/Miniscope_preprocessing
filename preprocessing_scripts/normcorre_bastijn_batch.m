function normcorre_bastijn_batch(dir_nm, name, file_nm, save_png)

% NoRMCorre
% function normcorre_bastijn_batch(save_png)
% write true to save figures rigid and nonrigid
...
fprintf('Total time to run NormCorre:     %.2f seconds\n', toc);
